...
%%%%%%%%%%%%%%%% reaction rates %%%%%%%%%%%%%%%%
%%%%%% bicarbonate and CA %%%%%%
EnAcc =6.8*10^2 ; % The effect of CA in acceleration of reaction ( Hydration of CO2)
...
%%%%%%%%%%%%%%%% ODE15s function %%%%%%%%%%%%%%%%
options = odeset('RelTol',1e-11,'AbsTol',1e-11,'Events',@myEvent); %%% For diffusion-reaction- or reaction only
